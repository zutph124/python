...
that same input with any :) converted to 🙂 (otherwise known as a slightly smiling face) and 
...
as by passing a str of your own as an argument to input. Be sure to call main at the bottom of you
'''
